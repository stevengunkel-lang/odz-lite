...
export default function AuftraegePage() {
  ...
  const kundenMitObjekt = useMemo(() => {
    return new Set(auftraege.map((auftrag) => auftrag.kunde_id)).size;
  }, [auftraege]);
  ...
  return (
    <div className="space-y-4 pb-4">
      ...
      <section className="rounded-[1.85rem] border border-rose-200/10 bg-white/[0.052] p-5 shadow-2xl shadow-black/30 backdrop-blur-xl">
        ...
        <p className="mt-1 text-sm text-white/55">
          Kunde reicht. Objekt, Arbeitsart, Ort und Notiz bleiben bewusst einfach.
        </p>
